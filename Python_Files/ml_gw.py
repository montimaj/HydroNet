...
def run_ml_gw():
    ...
    hydronet.perform_regression(use_pca_data=False, use_keras_tuner=False, validation_split=0.1, max_trials=1,
                                max_exec_trials=10, batch_size=32, epochs=2000, load_model=False, model_number=2)
